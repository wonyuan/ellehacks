...
def refine(situation):
    stream = co.chat_stream( 
        ...
        message='BASED ON THIS INFORMATION:'+ situation + " CREATE A PROFILE SUMMARY LIKE THIS: Hi I am a teen with ____ and I am ___. Make the description 2 to 3 sentences and try to come up with a similar scenario that has happened to the teen based on the given situation (not overly creative but target general teenager psychology - as accurate as possible)",
        temperature=0.3,
        chat_history=[],
        prompt_truncation='AUTO'
    ) 
